...
def tool(request, num):
    ...
    pages = list(range(1,21)) #add this line
    context = {"page":pages,"num" : num , 'pdfs' : pdf_list[::-1], "var" : pdf_list[int(num-1)] , "lpdf" : zippedlist, "next" : num+1, "back" : num-1 ,"lastnum" : len(pdf_list)+1}
